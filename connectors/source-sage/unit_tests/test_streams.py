...
import pytest
from source_sage.source import SageStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SageStream, "path", "v0/example_endpoint")
    mocker.patch.object(SageStream, "primary_key", "test_primary_key")
    mocker.patch.object(SageStream, "__abstractmethods__", set())
