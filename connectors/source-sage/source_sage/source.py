...
class SageStream(HttpStream, ABC):
    """
...
class IncrementalSageStream(SageStream, ABC):
    """
...
class Employees(IncrementalSageStream):
    """
    TODO: Change class name to match the table/data source this stream corresponds to.
    """
...
# Source
class SourceSage(AbstractSource):
